...
SpaceWasm incorporates code and test material derived from several third-party
projects. See the [NOTICE](./NOTICE) file for the full list of attributions and
licenses.
