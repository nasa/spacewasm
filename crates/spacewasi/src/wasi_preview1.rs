use spacewasm::{vec, HostFunction, HostModule, Value};
    ...
    HostModule {
        ...
        functions: vec![
            HostFunction::new("args_get", "ii".into(), "i".into(), {
                ...
                let Some(Value::I32(a1)) = args.get(1) else {panic!("expected i32");};
            ...
            HostFunction::new("clock_time_get", "iIi".into(), "i".into(), {
                ...
                let Some(Value::I32(a2)) = args.get(2) else {panic!("expected i32");};
            ...
            HostFunction::new("fd_advise", "iIIi".into(), "i".into(), {
                ...
                let Some(Value::I32(a3)) = args.get(3) else {panic!("expected i32");};
            ...
            HostFunction::new("fd_pread", "iiiIi".into(), "i".into(), {
                ...
                let Some(Value::I32(a1)) = args.get(1) else {panic!("expected i32");};
                let Some(Value::I32(a2)) = args.get(2) else {panic!("expected i32");};
                let Some(Value::I64(a3)) = args.get(3) else {panic!("expected i64");};
                let Some(Value::I32(a4)) = args.get(4) else {panic!("expected i32");};
            ...
            HostFunction::new("path_filestat_set_times", "iiiiIIi".into(), "i".into(), {
                ...
                let Some(Value::I32(a2)) = args.get(2) else {panic!("expected i32");};
                let Some(Value::I32(a3)) = args.get(3) else {panic!("expected i32");};
                let Some(Value::I64(a4)) = args.get(4) else {panic!("expected i64");};
                let Some(Value::I64(a5)) = args.get(5) else {panic!("expected i64");};
                let Some(Value::I32(a6)) = args.get(6) else {panic!("expected i32");};
            ...
            HostFunction::new("path_link", "iiiiiii".into(), "i".into(), {
                ...
                let Some(Value::I32(a3)) = args.get(3) else {panic!("expected i32");};
                let Some(Value::I32(a4)) = args.get(4) else {panic!("expected i32");};
                let Some(Value::I32(a5)) = args.get(5) else {panic!("expected i32");};
                let Some(Value::I32(a6)) = args.get(6) else {panic!("expected i32");};
            ...
            HostFunction::new("path_open", "iiiiiIIii".into(), "i".into(), {
                ...
                let Some(Value::I32(a4)) = args.get(4) else {panic!("expected i32");};
                let Some(Value::I64(a5)) = args.get(5) else {panic!("expected i64");};
                let Some(Value::I64(a6)) = args.get(6) else {panic!("expected i64");};
                let Some(Value::I32(a7)) = args.get(7) else {panic!("expected i32");};
                let Some(Value::I32(a8)) = args.get(8) else {panic!("expected i32");};
