...
(module
  (import "spectest" "return_i32_from_all_args"
    (func $return_i32_from_all_args (param i32 i64 f32 f64) (result i32)))
  (import "spectest" "return_i64" (func $return_i64 (result i64)))
  (import "spectest" "return_f32" (func $return_f32 (result f32)))
  (import "spectest" "return_f64" (func $return_f64 (result f64)))
  (import "spectest" "noop" (func $noop))
...
(assert_return (invoke "call-all-args") (i32.const 77))
