...
(assert_invalid
  (module (import "spectest" "table" (table 10 funcref)) (import "spectest" "table" (table 10 funcref)))
  "multiple tables"
)
(assert_invalid
  (module (import "spectest" "table" (table 10 funcref)) (table 10 funcref))
  "multiple tables"
)
(assert_invalid
...
(assert_invalid
  (module (import "spectest" "memory" (memory 1)) (import "spectest" "memory" (memory 1)))
  "multiple memories"
)
(assert_invalid
